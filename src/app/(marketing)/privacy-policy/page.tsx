      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto">
            En DepurApp valoramos y respetamos tu privacidad. Esta política
            detalla cómo protegemos tu información y cómo la utilizamos para
        ...
        <Section icon={ShieldCheck} title="1. Introducción">
          <p>
            ...
            protegemos la información que los usuarios proporcionan al utilizar
            nuestra plataforma.
          </p>
          <p>
            Al utilizar DepurApp, el usuario acepta las prácticas descritas en
            esta política, diseñada para garantizar un entorno seguro y
            profesional.
          </p>
        </Section>
        ...
        <Section icon={FileText} title="2. Información que recopilamos">
          <p>
            DepurApp puede recopilar la siguiente información proporcionada
          ...
          <ul className="list-disc pl-5 space-y-1 text-gray-300">
            ...
            <li>
              Información profesional contenida dentro del CV (experiencia,
        ...
        <Section
          icon={Eye}
          title="3. Uso de la información e Inteligencia Artificial"
        >
          ...
          <p className="bg-brand-purple/5 border-l-2 border-brand-purple p-3 italic">
            DepurApp no vende ni comparte información personal con terceros para
            fines comerciales externos. El procesamiento por IA de terceros se
            realiza exclusivamente para generar el análisis solicitado.
          </p>
        </Section>
        ...
        <Section icon={Lock} title="4. Protección y Almacenamiento">
          <p>
            Implementamos medidas técnicas razonables para evitar el acceso no
            autorizado, alteración o pérdida de datos. Los datos se almacenan de
            forma segura en servicios de infraestructura profesional.
          </p>
          <p className="text-xs text-gray-500">
            Nota: Ningún sistema en internet puede garantizar seguridad
            absoluta.
          </p>
        </Section>
        ...
        <Section icon={Trash2} title="5. Control del Usuario y Responsabilidad">
          <p>
            ...
            información, CV o cuenta completa.
          </p>
          <p className="font-bold text-red-400/80">
            Recomendación importante: No incluyas datos sensibles como número de
            identidad, dirección exacta o datos bancarios en tu CV. El usuario
            es responsable del contenido que decide subir.
          </p>
        </Section>
